<template>
  <v-container>
    <v-form @submit.prevent="submit">
      ...
      <v-row>
        <v-col cols="2">
          <v-btn color="red" to="/orders"> Back </v-btn>
        </v-col>
        <v-col class="ml-5" cols="2">
          <v-btn color="green" type="submit" :disabled="warehouse_name == ''">
            New
          </v-btn>
        </v-col>
      </v-row>
...
export default {
  ...
  methods: {
    submit() {
      ...
      formData.append("warehouse_name", this.warehouse_name);
